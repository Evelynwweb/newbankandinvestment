...
const TIMELINE = [
  { year: '2019', title: 'The first account', body: 'Aurivest opens with one conviction: private-bank quality shouldn’t require a private-bank balance.' },
...
export default function About() {
  ...
  return (
    <PageShell
      ...
      lede="Aurivest exists for one reason: to give everyone — first account or ninth figure — the same standard of banking, investing and advice."
      icon={Building2}
    >
      {/* mission */}
      <section className="max-w-7xl mx-auto px-5 sm:px-6 md:px-10 py-10 md:py-14">
        <Reveal>
          <div className="card rounded-md p-8 md:p-12 relative overflow-hidden">
            ...
            <p className="text-[12.5px] mt-6 uppercase tracking-widest relative text-[color:var(--muted-2)]">The Aurivest team</p>
          </div>
        </Reveal>
      </section>
