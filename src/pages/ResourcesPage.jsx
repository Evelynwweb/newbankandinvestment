      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-6 md:px-10 py-8 md:py-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-10">
          {[
            ...
            { title: 'A verification code', body: 'Codes we text you are for you alone. Anyone asking for one is not from Betament.' },
...
const FAQS = [
  ...
  { q: 'How fast are transfers?', a: 'Between your own Betament accounts, instantly and free. Domestic ACH is free and lands in one to two business days. Same-day wires are $15 and clear the same day if sent before the cut-off.' },
  ...
  { q: 'Can I get a loan or mortgage?', a: 'Yes — personal loans from 8.9% APR, auto from 6.4%, and 30-year fixed mortgages from 5.75% with no lender origination fee for Betament clients. All credit is subject to approval.' },
