...
const FAQS = [
  ...
  { q: 'Where are my assets actually held?', a: 'With an independent custodian, segregated from our own balance sheet and from other clients. If Betamint disappeared tomorrow, your securities and digital assets would still be yours, held by someone else.' },
