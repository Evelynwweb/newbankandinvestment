...
const FAQS = [
  ...
  { q: 'Where are my assets actually held?', a: 'With an independent custodian, segregated from our own balance sheet and from other clients. If Betament disappeared tomorrow, your securities and digital assets would still be yours, held by someone else.' },
  ...
  { q: 'How do I get money in and out?', a: 'In crypto. Your dashboard shows the receiving address for each asset and network we support; you send the transfer, upload the receipt, and the desk reviews it by hand before crediting your account. Withdrawals go to the wallet you save in Settings, which we approve once before the first payout.' },
