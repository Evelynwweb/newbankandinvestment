    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center px-5">
      ...
      <form onSubmit={submit} className="card-soft relative w-full max-w-[420px] p-7">
        ...
        <p className="text-[11.5px] mt-3 leading-relaxed text-[color:var(--muted-2)]">
          Orders settle at the published mark. Betament carries no live market feed — marks are set
  ...
  return (
    <>
      <PageHeader
        ...
        title="Account"
        subtitle="Every account, position and subscription you hold with Betament."
      >
